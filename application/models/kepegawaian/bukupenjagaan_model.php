...
class Bukupenjagaan_model extends CI_Model {
    ...
    function get_datagaji($start=0,$limit=999999,$options=array())
    {
        ...
        $this->db->select("pegawai.*,pangkat.nip_nit,gaji.tmt,mst_peg_golruang.id_golongan,gaji.masa_krj_bln,gaji.masa_krj_thn,mst_peg_golruang.ruang, '' as keterangan,gaji.gaji_baru");
        ...
        $this->db->join("mst_peg_golruang",'mst_peg_golruang.id = gaji.id_mst_peg_golruang','left');
