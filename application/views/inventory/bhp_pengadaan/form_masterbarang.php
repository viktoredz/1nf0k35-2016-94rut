    ...
    $(function(){
      $('#btn-close-master').click(function(){
        ...
        $('#form-ss-master').submit(function(){
            ...
            datamaster.append('code', $('#code_master').val());
            datamaster.append('uraian', $('#uraian_master').val());
            datamaster.append('merek_tipe', $('#merk_master').val());
            datamaster.append('negara_asal', $('#negara_master').val());
            datamaster.append('pilihan_satuan', $('#pilihan_satuan_barang_master').val());
            datamaster.append('harga', $('#harga_master').val());
            $.ajax({
                cache : false,
                contentType : false,
                processData : false,
