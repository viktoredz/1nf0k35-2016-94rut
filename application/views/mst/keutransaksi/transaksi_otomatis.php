    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-footer">
          <button type="button" class="btn btn-primary" onclick="document.location.href='<?php echo base_url()?>inventory/bhp_permintaan/add'"><i class='fa fa-plus-square-o'></i> &nbsp; Tambah Transaksi Otomatis</button>
       </div>
        <div class="box-body">
        <div class="div-grid">
            <div id="jqxgrid_transaksi_otomati"></div>
      </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function detail(id_pegawai){
    ...
    filter: function(){
      $("#jqxgrid_transaksi_otomati").jqxGrid('updatebounddata', 'filter');
    },
    sort: function(){
      $("#jqxgrid_transaksi_otomati").jqxGrid('updatebounddata', 'sort');
    },
    root: 'Rows',
        pagesize: 10,
    ...
    $('#btn-refresh').click(function () {
      $("#jqxgrid_transaksi_otomati").jqxGrid('clearfilters');
    });

    $("#jqxgrid_transaksi_otomati").jqxGrid(
    {   
      width: '100%',
      ...
      columns: [
        { text: 'Detail', align: 'center', filtertype: 'none', sortable: false, width: '5%', cellsrenderer: function (row) {
            var dataRecord = $("#jqxgrid_transaksi_otomati").jqxGrid('getrowdata', row);
  ...
  function del(id){
    ...
    if(confirms == true){
      $.post("<?php echo base_url().'mst/keuangan_transaksi/delete_kategori_transaksi' ?>/" + id,  function(){
        ...
        $("#jqxgrid_transaksi_otomati").jqxGrid('updatebounddata', 'cells');
      });
    }
  }
</script>
