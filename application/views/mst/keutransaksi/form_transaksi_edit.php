    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-1" style="padding-top:13px;"><label>1</label> </div>
              <div class="col-md-8" style="padding-top:5px;">
                <select  name="" type="text" class="form-control">
                  <?php foreach($kategori as $k) : ?>
                    <?php
          ...
          <div id="debit" class="col-md-8">
            <div class="row">
              <div class="col-md-1" style="padding-top:5px;"><label> Nilai </label> </div>
              <div class="col-md-5">
                <select  name="" type="text" class="form-control">
                  <?php foreach($kategori as $k) : ?>
                      <?php
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-1" style="padding-top:13px;"><label>2</label> </div>
              <div class="col-md-8" style="padding-top:5px;">
                <select  name="" type="text" class="form-control">
                  <?php foreach($kategori as $k) : ?>
                    <?php
    ...
    $("[name='transaksi_template']").click(function(){
      ...
      // alert($("[name='transaksi_template']:checked").val());
        ...
        $.ajax({
            ...
            processData : false,
            type : 'POST',
            url : '<?php echo base_url()."mst/keuangan_transaksi/transaksi_template_update/"?>'+$(this).val(),
            data : data,
            success : function(response){
              // a = response.split("|");
              if(response=="OK"){
