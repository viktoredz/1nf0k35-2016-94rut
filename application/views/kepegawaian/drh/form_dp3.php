...
<script type="text/javascript">
    ...
    filter: function(){
      $("#jqxgridDP3").jqxGrid('updatebounddata', 'filter');
    },
    sort: function(){
      $("#jqxgridDP3").jqxGrid('updatebounddata', 'sort');
    },
    root: 'Rows',
        pagesize: 10,
    ...
    $('#btn-ortu-refresh').click(function () {
      $("#jqxgridDP3").jqxGrid('clearfilters');
    });
    ...
    {   
      ...
      columns: [
        { text: 'Detail', align: 'center', filtertype: 'none', sortable: false, width: '5%', cellsrenderer: function (row) {
            var dataRecord = $("#jqxgridDP3").jqxGrid('getrowdata', row);
  ...
  function del(id,urut){
    ...
    if(confirms == true){
      $.post("<?php echo base_url().'kepegawaian/drh_keluarga/biodata_keluarga_ortu_del' ?>/" + id +"/"+urut,   function(){
        ...
        $("#jqxgridDP3").jqxGrid('updatebounddata', 'cells');
      });
    }
  }
