...
<script type="text/javascript">
    ...
    {   
      ...
      columns: [
        { text: 'Detail', align: 'center', filtertype: 'none', sortable: false, width: '5%', cellsrenderer: function (row) {
            ...
            return "<div style='width:100%;padding-top:2px;text-align:center'><a href='javascript:void(0);'><img border=0 src='<?php echo base_url(); ?>media/images/16_edit.gif' onclick='detail_pns (\""+dataRecord.id_pegawai+"\",\""+dataRecord.id_mst_peg_jurusan+"\");'></a></div>";
          }else{
        ...
        { text: 'Del', align: 'center', filtertype: 'none', sortable: false, width: '5%', cellsrenderer: function (row) {
            ...
            return "<div style='width:100%;padding-top:2px;text-align:center'><a href='javascript:void(0);'><a href='javascript:void(0);'><img border=0 src='<?php echo base_url(); ?>media/images/16_del.gif' onclick='del_pns (\""+dataRecord.id_pegawai+"\",\""+dataRecord.id_mst_peg_jurusan+"\");'></a></div>";
          }else{
        ...
        { text: 'Nomor', datafield: 'spmt_nomor', columngroup: 'sttpl',columntype: 'textbox', filtertype: 'textbox', align: 'center', cellsalign: 'center', width: '10%' },
        { text: 'Tanggal', datafield: 'spmt_tgl', columngroup: 'sttpl',columntype: 'textbox', filtertype: 'textbox', align: 'center', cellsalign: 'center', width: '10%' },
        ...
        { text: 'Tanggal', datafield: 'dokter_tgl', columngroup: 'dokter',columntype: 'textbox', filtertype: 'textbox', align: 'center', cellsalign: 'center', width: '10%' },
            ],
         columngroups: 
        [
  ...
  function detail_pns(id,id_jurusan){
      ...
      $.get("<?php echo base_url().'kepegawaian/drh_pangkat/biodata_pangkat_pns_edit' ?>/" + id +"/"+id_jurusan,  function(data) {
  ...
  function del_pns(id,id_jurusan){
    var confirms = confirm("Hapus Data ?");
    if(confirms == true){
      $.post("<?php echo base_url().'kepegawaian/drh_pangkat/biodata_pangkat_pns_del' ?>/" + id +"/"+id_jurusan,   function(){
