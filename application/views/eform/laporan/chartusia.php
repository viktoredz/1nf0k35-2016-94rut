        ...
        datasets: [
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmlinfant']))  $x = ($row['jmlinfant']/$row['total']*100);
              else                              $x = 0;
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmltoddler']))  $x = ($row['jmltoddler']/$row['total']*100);
              else                              $x = 0;
          ...
          },
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmlpreschool']))  $x = ($row['jmlpreschool']/$row['total']*100);
              else                              $x = 0;
          ...
          },
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmlsekolah']))  $x = ($row['jmlsekolah']/$row['total']*100);
              else                              $x = 0;
          ...
          },
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmlremaja']))  $x = ($row['jmlremaja']/$row['total']*100);
              else                              $x = 0;
          ...
          },
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmldewasa']))  $x = ($row['jmldewasa']/$row['total']*100);
              else                              $x = 0;
          ...
          },
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmlprelansia']))  $x = ($row['jmlprelansia']/$row['total']*100);
              else                              $x = 0;
          ...
          },
          {
            ...
            $i=0;
            foreach ($bar as $row ) { 
              if(isset($row['jmllansia']))  $x = ($row['jmllansia']/$row['total']*100);
              else                              $x = 0;
