...
class Bhp_kondisi extends CI_Controller {
	...
	function pengadaan_export(){
		...
		$rows = $this->bhp_kondisi_model->get_data_export(/*$this->input->post('recordstartindex'), $this->input->post('pagesize')*/);
		$data_tabel = array();
		$no=1;
		//$unlock = 1;
	...
	function json(){
		...
		$rows_all = $this->bhp_kondisi_model->get_data();
		...
		$rows = $this->bhp_kondisi_model->get_data($this->input->post('recordstartindex'), $this->input->post('pagesize'));
		$data = array();
		$no=1;
		//$unlock = 1;
